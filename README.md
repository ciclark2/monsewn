...
`sudo apt-get install libxcb-render0-dev libxcb-shape0-dev libxcb-xfixes0-dev libspeechd-dev libxkbcommon-dev libssl-dev libfontconfig-dev`
...
You can test the template app at <https://ciclark2.github.io/monsewn/>.
